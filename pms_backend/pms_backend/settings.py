"""
Django settings for the FIFTH Property Management System project.
"""
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-fifth-pms-secret-key-change-in-production')
